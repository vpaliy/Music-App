...
public enum MusicMatchEnum {
    ...
    MELOPHILE_TRACKS(701,MelophileThemes.CONTENT_DIR_TYPE,Tables.MELOPHILE_TRACKS,MusicContract.PATH_MELOPHILE_THEMES),
    MELOPHILE_PLAYLISTS(702,MelophileThemes.CONTENT_DIR_TYPE,Tables.MELOPHILE_PLAYLISTS,MusicContract.PATH_MELOPHILE_THEMES),
